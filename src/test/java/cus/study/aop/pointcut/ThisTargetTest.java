...
public class ThisTargetTest {
    ...
    static class ThisTargetAspect {
        //부모 타입 허용
        @Around("this(cus.study.aop.member.MemberService)")
        ...
        //부모 타입 허용
        @Around("target(cus.study.aop.member.MemberService)")
        ...
        @Around("this(cus.study.aop.member.MemberServiceImpl)")
        ...
        @Around("target(cus.study.aop.member.MemberServiceImpl)")
